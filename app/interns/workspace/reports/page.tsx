    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-8 flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-400">Track your submitted reports</p>
        </div>
      ...
      <div className="space-y-4">
        {reports.length > 0 ? (
          reports.map((report) => (
            <div key={report.id} className="bg-slate-800 border border-slate-700 rounded-xl p-6">
              ...
              <div className="flex items-center justify-between text-sm text-slate-400 mt-4">
                ...
                <Link href={`/interns/workspace/reports/${report.id}`}>
